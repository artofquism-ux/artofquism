 ...
 tabs: [
    {
      name: "Quism Source",
        blocks: [
          ...
          type: "heading",
          title: "Quism Source :",
          text: "quism shows that Eternal life is a reflection of the first life on earth related to unconscious mind, i.e. sub-reality",
        },
  ...
  
    {
      name: "Quism Seed",
       blocks: [
       {
          type: "heading",
          title: "Quism Seed : ",
          text: "Every form contains  a formula, Qism art is also expressed through symbolic and imaginary formulas;",
        },
     
  {
    ...
    {
    type: "section",
    title: "Seed Principles of Quism Art Through Fictional Formulas:",
    text: "The foundational knowledge of Quism art is expressed through symbolic and fictional formulas; every form arises from an underlying principle, such as the coexistence of mind and consciousness within the physical body, where life and nature exchange breath and advance through a definite cycle of time; within this natural rhythm, subatomic particles mirror cosmic processes, enabling the continuous evolution of existence; all formulas and structures of thought are encoded in symbolic systems—the alphabet from A to Z and the numbers 0 to 9—both inherently rooted in emptiness, or the Zero Hour, from which form, meaning, and transformation perpetually emerge;",
 }, 
    {
    type: "section",
    text: "In Quism, these symbols function not merely as linguistic or numerical tools but as universal archetypes through which life, time, and consciousness manifest, dissolve, and renew themselves in rhythmic continuity;",
 }, 
     {
     type: "section",
     title: "G = C(Q), Gestation as a Whole-Queue Life Model:",
     text: "G = C(Q) defines gestation as the condensation of life and consciousness into a primordial point (Q); Gestation represents an eternal three-dimensional life cycle, encompassing creation, stability, and transformation (destruction);",
 }, 
    {
    type: "section",
    text: "The period of 0–9 months, or the 'Zero Hour,' signifies a phase of complete development in which C (body cells) advance through reproduction, carrying forward life from its earliest origins on Earth to the present biological form;",
 },
     {
      type: "section",
     text: "The sequence QRSTU functions as a symbolic Whole-Queue, where Q → U denotes a complete continuum of life—from primal existence to contemporary human birth; within this series, 'QU' necessarily appears together, just as parental sources unite to generate life;",
},
    {
    type: "section",
    text: "Thus, the contraction (QRSTU) → (QU) → (Q) represents generation, parenthood, and birth, respectively;",
 }, 
    {
    type: "section",
    text: "Q, as birth, marks the terminal point of manifestation and is experientially expressed through light, heat, and sound; the vowels A, E, I, O, U function as primal resonant carriers, while the alphabetical sequences QRSTU and VWXYZ symbolically articulate the emergence of light and heat as pathways toward self-realization;",
 }, 
    {
    type: "section",
    text: "Within this symbolic system, XYZ represents both biological and metaphysical convergence; X and Y chromosomes are unified through Z, denoting the Zero Hour—the gestational interval of 0–9 months; here, zero (0) functions as the generative origin, and the numerical sequence 0–9 becomes its differentiated reflection; the figure 8 embodies continuity and return, while 9 and 6 appear as complementary opposites, sustaining an eternal cyclic movement;",
 }, 
    {
     type: "section",
       ...
       blocks: [
        {
          type: "heading",
          title: "Quism Quotes",
          text: "The birth cycle mirrors zero hours, the life cycle unfolds as a reflection of primordial zeroness;"
        },
        
{
    ...
    {
    type: "section",
    text: "0) 'Zeroness is the Zero Hour where life, nature, and vitality converge, transforming into body, mind, and consciousness'",
 }, 
    {
     type: "section",  
     text: "1) 'Birth reflects the Zero Hour—0 to 9 months of enclosed breath—where a state of suffocation gives rise to the resurrection of life through concentrated breathing'",
 }, 
    {
     type: "section",
     text: "2) 'Breath is life; deep breathing is consciousness—the self-expression of the unconscious as it unfolds through self-awareness'",
 },
    {
     type: "section",
     text: "3) 'Through the buzzing chant of bees upon closed lips, body cells renew; brain neurons pulse like a heartbeat, revealing the intimate connection between life and nature'",
 },
    {
     type: "section",
     text: "4) 'Meditative life moves toward the ultimate goal through the inner journey, just as diamonds, emeralds, and crystals are revealed with clarity through the laws of nature'",
}, 
    {
    type: "section",  
    text: "5) 'The bodies of men and women are absolute by birth; parental sources remain undivided, serving the shared purpose of psychological evolution'",
},
    {
    type: "section",  
    text: "6) 'From the feeling of birth–death to dead–nectar, the compromising mind finds its guidance, while insight is revealed within the inner being'",
 },
    {
    type: "section",
    text: "7) 'From seed to seed-bearing tree, natural life is glorified by the laws of nature; the Absolute Being remains ever immersed in the unfolding of creation'",
 },
    {
     type: "section",
     text: "8) 'Self-realization affirms that life is enriched by lived experience, even as the mystery of creation continues to unfold through dreams'",
 },
   {
    type: "section",
    text: "9) 'The insight born of the perseverance of loneliness perceives the harmony between the inner and outer worlds, where everything is revealed as either truth or illusion'",
 },
  {
   type: "divider-white",
  }
