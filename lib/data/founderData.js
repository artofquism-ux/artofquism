export const founderData = {
 title: "FOUNDER",
  ...
  tabs: [
  {
    name: "Founder's Philosophy",
   blocks: [
 
        {
          type: "heading",
          text: "Founder's Philosophy : Eternal energy & vitality in the perseverance of loneliness",
        },
   ...
   {
    name: "Spiritual Expressions",
     blocks: [
           {
          type: "heading",
          text: "Spiritual Expressions: Pushpanjali 'Offerings of silence, devotion & inner light'",
           },
         {
           type: "article",
